...
// ---------------------------------------------------------------------------
// Detail-page URL discovery — REPLACES the old broken version.
//
// The old version scraped /report/ipo-in-india-list-main-board-sme/82/...
// and ipo_perf_tracker.asp's MAIN table. Both render their IPO table via
// client-side AJAX — a plain axios.get() sees "Loading...", "Total
// Records: 0" / "No Record Found." with zero <a href="/ipo/..."> links,
// for ANY company. That's why "Fetch Missing Data" always silently failed.
// ---------------------------------------------------------------------------
